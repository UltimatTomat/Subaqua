...
async def main():
    ...
    death_sound = pygame.mixer.Sound("Sounds/Effects/Death.ogg")
    coin_sound = pygame.mixer.Sound("Sounds/Effects/Coin.ogg")
    button_sound = pygame.mixer.Sound("Sounds/Effects/Button.ogg")
    ...
    while True:    
        ...
        if stage == 1:
            if death == True:
                ...
                pygame.mixer.music.load(f"Sounds/Music/Lobby.ogg")
        ...
        if stage == 2:
            if game_start == True:
                game_start = False
                pygame.mixer.music.load(f"Sounds/Music/Game.ogg")
                pygame.mixer.music.play(-1)
            ...
            if submarine_mask.overlap(obstacle1_mask, (obstacle1_rect[0] - submarine_rect.x, obstacle1_rect[1] - submarine_rect.y)) or submarine_mask.overlap(obstacle2_mask, (obstacle2_rect[0] - submarine_rect.x, obstacle2_rect[1] - submarine_rect.y)) or submarine_mask.overlap(obstacle3_mask, (obstacle3_rect[0] - submarine_rect.x, obstacle3_rect[1] - submarine_rect.y)):
                ...
                if int(current_highscore) < survived_time:
                    current_highscore = survived_time
